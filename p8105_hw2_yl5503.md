...
```
    ...
    ## ℹ In argument: `amyloid = as.numeric(amyloid)`.
    ## Caused by warning:
...
It can be seen that participant \#’s 14,49, 92, 179, 268, 304, 389 and
412 were unique to the baseline dataset while participant \#’s 484, 485,
486, 487, 488, 489, 490, 491, 492, 493, 494, 495 were unique to the
amyloid dataset.

``` r
combined_b_a <- inner_join(baseline_df, amyloid_df, by = "ID")
```

    ## Warning in inner_join(baseline_df, amyloid_df, by = "ID"): Each row in `x` is expected to match at most 1 row in `y`.
...
```
    ...
    ## # A tibble: 2,375 × 8
    ##    ID    baseline_age sex    years_of_education apoe_car…¹ onset…² time  amyloid
    ##    <chr>        <dbl> <fct>               <dbl> <fct>        <dbl> <fct>   <dbl>
    ##  1 1             63.1 female                 16 yes             NA base…   0.111
    ##  2 1             63.1 female                 16 yes             NA time…  NA    
    ##  3 1             63.1 female                 16 yes             NA time…   0.109
    ##  4 1             63.1 female                 16 yes             NA time…   0.105
    ##  5 1             63.1 female                 16 yes             NA time…   0.107
    ##  6 2             65.6 female                 20 yes             NA base…   0.107
    ##  7 2             65.6 female                 20 yes             NA time…   0.109
    ##  8 2             65.6 female                 20 yes             NA time…   0.109
    ##  9 2             65.6 female                 20 yes             NA time…   0.106
    ## 10 2             65.6 female                 20 yes             NA time…   0.107
    ## # … with 2,365 more rows, and abbreviated variable names ¹​apoe_carrier,
    ## #   ²​onset_age
